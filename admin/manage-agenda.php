...
<title>Manage Agenda Items — Admin</title>
      ...
      <main class="p-8 max-w-5xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
          ...
          <label class="flex items-center gap-2 text-xs text-slate-600">
            <input type="checkbox" id="show-archived" class="rounded border-[--line-200]" /> Show archived items
          </label>
        </div>
        <h1 class="font-display text-xl text-ink-900">Manage Agenda Items</h1>
        <div id="agenda-admin-list" class="space-y-3"></div>
      </main>
    </div>
  </div>
